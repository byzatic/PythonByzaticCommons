...
from src.LibByzaticCommon.InMemoryStorages.ABCAbstractCollection.KeyValueModuleTypeStorageInterface import KeyValueModuleTypeStorageInterface
from src.LibByzaticCommon.Exceptions.OperationIncompleteException import OperationIncompleteException


class KeyValueModuleTypeStorage(KeyValueModuleTypeStorageInterface):
    def __init__(self, storage_name: str, critical_dump_flag: bool = True):
        ...
        Is a descendant of the LibByzaticCommon.NodeStorage.ABCAbstractCollection.KeyValueStringStorageInterface
    ...
    def create(self, key: str, value: ModuleType) -> None:
        """
    ...
    def read(self, key: str) -> ModuleType:
        """
    ...
    def update(self, key: str, value: ModuleType) -> int:
        """
    ...
    def __check_if_value_empty(self, value: ModuleType, ops_name: str) -> None:
        try:
            pass
        except OperationIncompleteException as oie:
            raise OperationIncompleteException(oie.args, errno=oie.errno)
