...
import inspect
from src.LibByzaticCommon.InMemoryStorages.ABCAbstractCollection.KeyValueStoragesStorageInterface import \
    KeyValueStoragesStorageInterface
from src.LibByzaticCommon.InMemoryStorages.ABCAbstractCollection.KeyValueStorageInterface import \
    KeyValueStorageInterface
from src.LibByzaticCommon.Exceptions.OperationIncompleteException import OperationIncompleteException


class KeyValueStoragesStorage(KeyValueStoragesStorageInterface):
    def __init__(self, storage_name: str, critical_dump_flag: bool = True):
        ...
        Is a descendant of the LibByzaticCommon.NodeStorage.ABCAbstractCollection.KeyValueStoragesStorageInterface
        Brief description of application:
                                        Key: str
                                        Value: KeyValueStoragesStorageInterface
    ...
    def create(self, key: str, value: KeyValueStorageInterface) -> None:
        """
        Create string value in storage by key
        @param key: string identification parameter
        @param value: object value parameter
    ...
    def read(self, key: str) -> KeyValueStorageInterface:
        """
    ...
    def update(self, key: str, value: KeyValueStorageInterface) -> int:
        """
    ...
    # TODO: not ready
    def __check_if_value_empty(self, value: KeyValueStorageInterface, ops_name: str) -> None:
        pass
